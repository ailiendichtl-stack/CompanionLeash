...
registerForEvent("onDraw", function()
  ...
  if Triggers and ImGui.CollapsingHeader("Aufhelfen", ImGuiTreeNodeFlags.DefaultOpen) then
    ...
    ImGui.TextDisabled(string.format("NCA-Menue im Kampf: %s   umgangen %dx",
                       l.riegel and "geoeffnet" or "nicht erreichbar", l.umgangen or 0))
    ImGui.TextWrapped("NCAs Menue steigt bei `isInCombat` aus. Der Riegel wird jetzt nur "
                      .. "fuer die Dauer des Aufrufs gedreht, und nur wenn sie liegt.")
  end
